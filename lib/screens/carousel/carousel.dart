										...
										child: ListView(
											children: <Widget>[
												...
												GFCarousel(
													...
													aspectRatio: 2,
													items: gradientColor.map((url) => GFCard(
															...
															child: Column(
																...
																children: const <Widget>[
																	...
																	Padding(
																		...
																		child: Text(
																			'GetWidget is an open source library that comes with 1000+ pre-built UI components.',
												...
												GFItemsCarousel(
													rowCount: 3,
													children: assetImg.map((url) => GFCard(
														gradient: LinearGradient(
									...
									Container(
										child: ListView(
											children: <Widget>[
												...
												GFItemsCarousel(
													rowCount: 3,
													children: imageList.map((url) => GFImageOverlay(
														height: 400,
														width: 300,
														margin:
																const EdgeInsets.only(left: 15, right: 5),
